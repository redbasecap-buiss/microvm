...
pub fn generate_dtb_smp(
    ...
    let isa_str = "rv64imafdcsu_zicsr_zifencei_zicbom_zicboz_zicbop_zicond_zihintpause_zawrs_zacas_zabha_zfa_zimop_zcmop_zba_zbb_zbs_zbc_sstc_zicntr_svinval_svpbmt_svadu";
