...
pub fn generate_dtb(
    ...
    b.prop_str(
        "riscv,isa",
        "rv64imacsu_zicsr_zifencei_zicbom_zicboz_zicbop_zba_zbb_zbs_zbc_sstc_zicntr_svinval",
    );
    ...
    b.prop_stringlist(
        ...
        &[
            "i", "m", "a", "c", "zicsr", "zifencei", "zicbom", "zicboz", "zicbop", "zba", "zbb",
            "zbs", "zbc", "sstc", "zicntr", "svinval",
        ],
    );
